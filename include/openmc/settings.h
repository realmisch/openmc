...
extern bool use_material_ueg;        //!< use unionized material grid and cross sections
...
extern double ue_grid_cutoff;      //!< Grid thinning tolerance for unionized energy grids
